...
(function ($) {
    ...
    var allocationData = {
        labels: ["Contrat LCL", "Contrat BNB"],
          datasets: [
            {
                fill: true,
    ...
    var contractChart = document.getElementById("contract-chart");
    var contractCtx = contractChart.getContext('2d');
    contractChart.height = 80;
    var datapack1 = [65, 59, 80, 81, 56, 55, 40];
    var datapack2 = [28, 48, 40, 19, 90, 27, 75];
    var contractConfig = new Chart(contractCtx, {
        type: 'line',
        data: {
            labels: ["16th", "17th", "18th", "19th", "20th", "21th", "22th"],
            datasets: [{
                    label: 'Series A',
                    backgroundColor: '#7FE6CC',
                    borderColor: '#7FE6CC',
                    borderWidth: 2,
                    data: datapack1
                },
